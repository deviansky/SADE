  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-64 bg-indigo-700 text-white">
        ...
        <nav className="mt-4">
          <div className="px-4 py-3 bg-indigo-800 flex items-center">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            <div className="bg-white p-4 rounded-lg shadow">
              <div className="text-sm text-gray-500 mb-1">Total Penghuni Asrama</div>
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="col-span-2 bg-white p-4 rounded-lg shadow">
              ...
              <div className="h-48 w-full">
                <svg viewBox="0 0 400 150" className="w-full h-full">
                  ...
                  <line x1="0" y1="80" x2="400" y2="80" stroke="#eee" strokeWidth="1" />
                  <line x1="0" y1="40" x2="400" y2="40" stroke="#eee" strokeWidth="1" />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-4 rounded-lg shadow">
                ...
                <div className="grid grid-cols-7 gap-1 text-xs">
                  ...
                  {calendarDays.map((day) => (
                    <div 
                      key={`day-${day}`} 
                      className={`text-center p-1 rounded-full ${day === currentDate.getDate() ? 'bg-indigo-700 text-white' : ''}`}
                    >
                      {day}
                    </div>
                  ))}
              ...
              {/* Progress Circle */}
              <div className="bg-white p-4 rounded-lg shadow">
                <h2 className="font-bold mb-2">Rate-rata Kehadiran Bulan ini</h2>
