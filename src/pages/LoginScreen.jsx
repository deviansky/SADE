        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input type="text" placeholder="abcd@gmail.com" className="w-full px-4 py-2 rounded-2xl border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-blue-500 mb-5"  />
              {/* <input
                type="text"
                id="username"
                value={username}
              ...
              <input type="text" placeholder="password" className="w-full px-4 py-2 rounded-2xl border border-indigo-500 focus:outline-none focus:ring-2 focus:ring-blue-500 mb-5"  />
              <button className="w-full py-2 bg-indigo-700 text-white font-medium rounded-xl">
                Login Akun
              </button>
            </div>
          </form>
